...
setup(
    ...
    version=__version__,
    description="A JupyterLab extension that displays session information in a beautiful popup with automatic clipboard copying",
    long_description=long_description,
    long_description_content_type="text/markdown",
    author="wenmin-wu",
    author_email="wuwenmin1991@gmail.com",
    url="https://github.com/wenmin-wu/jupyter-session-tracer",
    license="BSD-3-Clause",
    platforms="Linux, Mac OS X, Windows",
    keywords=["jupyter", "jupyterlab", "jupyterlab-extension", "session-tracer"],
    classifiers=[
        "Framework :: Jupyter",
